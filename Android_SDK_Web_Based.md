...
You can check the latest releases [here](https://central.sonatype.dev/artifact/co.pisano.feedback/feedback/1.3.4).
...
```yaml
dependencies {
    implementation 'co.pisano.feedback:feedback:1.3.7'
}
```
### Permissions
