...
You can check the latest releases [here](https://central.sonatype.com/artifact/co.pisano.feedback/feedback/1.3.17).
...
```yaml
dependencies {
    implementation 'co.pisano.feedback:feedback:1.3.17'
}
```
### Permissions
